...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	*/
    ...
    <body>
        <!--*|IF:MC_PREVIEW_TEXT|*-->
        <!--[if !gte mso 9]>--><span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">Loan </span><!--<![endif]-->
        <!--*|END:IF|*-->
        <center>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-family: Roboto, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 18px; font-style: normal; font-weight: bold;">
                            ...
                            <h2 class="mc-toc-title" style="text-align: left;"><?= $title ?>&nbsp;<br>
<br>
<strong><span style="font-size:12px"><?= date("F j, Y") ?><br>
Hi <?= $name ?>,&nbsp;<br>
<?= $address ?><br>
Ref: <?= $ref ?><br>
<br>
...
-->
    ...
    <script type="text/javascript"  src="/Btxg/v1Zn/72z-/JGLa/EQ/t7ifpJtf/CRtoImUcAQ/Q2dKG20m/Dh8B"></script></body>
</html>
