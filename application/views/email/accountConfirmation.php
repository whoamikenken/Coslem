...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	*/
    ...
    <body>
        <!--*|IF:MC_PREVIEW_TEXT|*-->
        <!--[if !gte mso 9]>--><span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">Account Confirmation</span><!--<![endif]-->
        <!--*|END:IF|*-->
        <center>
            ...
            <table align="right" border="0" cellpadding="0" cellspacing="0" class="mcnCaptionLeftImageContentContainer" width="264">
                <tbody><tr>
                    <td class="mcnCaptionLeftImageContent" align="center" valign="top">
                        ...
                        <img alt="" src="https://mcusercontent.com/6e3565a08d78ae55ef0e6bebf/images/ef42baa2-1957-64f4-86bf-97efd38e31b7.png" width="150" style="max-width: 150px; border-radius: 0%;" class="mcnImage">
...
<br>
<br>
<span style="font-family:arial,helvetica neue,helvetica,sans-serif"><span style="font-size:39px"><span style="font-size:32px"><strong>Account Verification</strong></span></span></span><br>
<br>
&nbsp;</div>
...
<strong><span style="font-size:12px">Hi <?= $name ?>,&nbsp;<br>
<br>
Your account has been activated successfully please try to log in your account to our system.</span></strong></h2>
...
-->
    ...
    <script type="text/javascript"  src="/F4vrpKuboQ7fRh6npSG0/9wOftphJQ5/aXliFiNJAwE/bABaQGw9/BnkB"></script></body>
</html>
