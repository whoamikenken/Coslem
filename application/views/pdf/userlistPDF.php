<?php
$record = $this->setup->getUserList("",$usertype);
...
<htmlpageheader name='Header'>
    <div>
        <table width='60%'  >
            ...
            <tr>
                <td valign='middle' style='padding: 0;text-align: center;'><span style='font-size: 13px;' width='45%'><strong>User List Report</strong></span></td>
            </tr>
        </table>
    </div>
</htmlpageheader>";
...
<div class='content'>
    <div class='content-header'>
        <table border=1 width='100%' style='font-size: 9px;' id='datas'>
            ...
            <th style='padding: 5px;text-align: center;font-size: 20px;font-weight: bold;'>ID</th>
            <th style='padding: 5px;text-align: center;font-size: 20px;font-weight: bold;'>Username</th>
            <th style='padding: 5px;text-align: center;font-size: 20px;font-weight: bold;'>Name</th>
            <th style='padding: 5px;text-align: center;font-size: 20px;font-weight: bold;'>Email</th>
            <th style='padding: 5px;text-align: center;font-size: 20px;font-weight: bold;'>Mobile</th>
...
$info .= "<tbody>";
            foreach($record as $emp){
                    $info .= "<tr>
                            ...
                            <td style='padding: 2px;text-align: center;font-size: 13px;'>".$emp['username']."</td>
                            <td style='padding: 2px;text-align: center;font-size: 13px;'>".$emp['name']."</td>
                            <td style='padding: 2px;text-align: center;font-size: 13px;'>".$emp['email']."</td>
                            <td style='padding: 2px;text-align: center;font-size: 13px;'>".$emp['mobile']."</td>
