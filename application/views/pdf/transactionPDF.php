...
<htmlpageheader name='Header'>
    <div>
        <table width='60%'  >
            ...
            <tr>
                <td valign='middle' style='padding: 0;text-align: center;'><span style='font-size: 13px;' width='45%'><strong>Community-Based Savings and Leanding Management System</strong></span></td>
            </tr>
            <tr>
