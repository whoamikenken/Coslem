<?php
$loanDesc = "Add";
if ($this->session->userdata("type") == "member") $loanDesc = "Request";

?>

<button type="button" class="btn btn-primary addbtn"><span style="font-family: Tahoma;"> <?php echo $loanDesc ?> New Loan </span></button><br><br>
    ...
    $(".addbtn").click(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#modal-view").find(".modal-title").text("<?php echo $loanDesc ?> Loan");
